...
5.5. **Запись решений в Decision Log**:
   ...
   - В разделе "Decision Log" → "История решений" (в конце файла `tech-stack.md`) добавь записи для **КАЖДОГО** компонента стека:
   ...
   - Для каждого решения укажи:
     ...
     - **Связанные решения**: ссылки на решения из `concept.md` и `ui-design.md`, которые повлияли на выбор технологий
...
5.6. **Обновление project-context.md**:
   - Обнови `.pldf/project-context.md`:
     ...
     - Добавь ссылку на Decision Log в `tech-stack.md`
...
7. **Создание документации стека**:
   ...
   - Сохрани в `.pldf/tech-stack.md` (с Decision Log в конце)
